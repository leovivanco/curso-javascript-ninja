...
(function () {
  ...
  */
  ...
  function isOperatorValid(val) {
      return Boolean(operation[val])
  }
  ...
  */
    // operationSignal = '%';
    // let mod2 = calculator(operationSignal);
    // console.log(mod2(number1, number2));
    operationSignal = '´´';
    let mod12 = calculator(operationSignal)

    if (mod12) {
        let number1 = 15;
        let number2 = 10;
        console.log(showOperationMessage(operationSignal, number1, number2), mod12(number1, number2))
    } else {
        console.log(showErrorMessage(operationSignal))
