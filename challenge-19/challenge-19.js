(function() {
    ...
    */
    ...
    //     let regex = /class=\W+(.+?)\W>/gm;
    //     let match = regex.exec(markup);
    //     let array = [];
    //     while (match != null) {
    //         if (match[1].indexOf(' ') > -1) {
    //             let arrayEspace = match[1].split(' ');
    //             array.push(arrayEspace[0], arrayEspace[1])
    //         }else{
    //             array.push(match[1])
    //         }
    ...
    let array = ['container', 'text', 'date', 'excerpt', 'longa0vida'];

    array.forEach(cssClass => console.log(`${hasClass(markup, cssClass)} para a classe ${cssClass}`))
