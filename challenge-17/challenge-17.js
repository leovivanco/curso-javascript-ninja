(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Leonardo Vivanco'));
    ...
    */
    ...
    console.log(`O mês de ${getMonthNumber('janeiro')[1]} é representado pelo número ${getMonthNumber('janeiro')[0]}`);
    ...
    */
    ...
    function replaceDate(dia,mes,ano) {
        ...
        return `${dia}/${getMonthNumber(mes)[0]}/${ano}`;
    }
