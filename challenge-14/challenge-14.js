;(function() {
    ...
    */
    ...
    let linguaDoP = name.reduce(function(acumulado, total) {
    ...
    */
    console.log( '\nInversed Name:' );
    let inversedName = name.reduceRight(function(acumulado, total) {
    ...
    */
    ...
    if (numberObjects.indexOf({ number: 2 }) > -1) {
        ...
        //Não entra no if porque é outro objeto na memoria
    }
