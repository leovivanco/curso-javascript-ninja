(function () {
    ...
    */
    ...
    let junhoJulho = `Os meses de janeiro, junho e julho começam com a letra j.`;

    console.log(junhoJulho.match(/ju\w{3}/g));
    ...
    */
    ...
    let divs = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    console.log(
        divs.match(/<\w+>/g)
    );
    ...
    */
    ...
    let html = `<h1>Título da página</h1>
    <p>Este é um parágrafo</p>
    <footer>Rodapé</footer>`;
    console.log(
        
    );
    let html2 = html.replace(/<(\w+)>([^<]+)<\/\w+>/gi, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n');
    console.log(html2);
